...
Errors are returned as RFC 9457 `application/problem+json` carrying a stable \
`slug`, `title`, `detail`, and — where relevant — a `reason`.",
        contact(name = "Workflow", url = "https://github.com/"),
        license(name = "Proprietary")
    ),
    servers((url = "/", description = "Same-origin (the web app proxies /api to this server)")),
    ...
    paths(
        ...
        crate::github::routes::rerun_route,
        crate::github::routes::create_branch_route,
        ...
        crate::jira::routes::board_mapping,
        crate::jira::routes::set_board_mapping,
        ...
        // Hub
        crate::hub::routes::board_route,
        crate::hub::routes::link_route,
    ...
    components(schemas(
        ...
        crate::github::routes::RerunBody,
        crate::github::routes::CreateBranchBody,
        wf_github::GithubBranchCreated,
        crate::jira::routes::JiraBoardMapping,
        crate::jira::routes::JiraBoardColumn,
        crate::hub::types::HubBoard,
        crate::hub::types::HubBoardContext,
        crate::hub::types::HubColumn,
        crate::hub::types::HubTicketCard,
        crate::hub::types::HubPrRef,
        crate::hub::types::HubDeployment,
        crate::hub::types::HubFavoriteWorkflow,
        crate::hub::types::HubOrphans,
        crate::hub::types::HubOrphanPr,
        crate::hub::types::HubOrphanBranch,
        crate::hub::types::HubOrphanTicket,
        crate::hub::types::HubLinkSuggestion,
        crate::hub::types::HubLinkBody,
        crate::hub::types::HubInbox,
        crate::hub::types::HubBrief,
        crate::hub::types::HubInboxItem,
        crate::hub::types::HubInboxQa,
        crate::hub::types::HubInboxRun,
